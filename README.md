<p align="center">
  <img src="docs/images/openrs-wordmark.svg" width="300" alt="openRS_"><br/>
...
| Token | Hex | Usage |
|-------|-----|-------|
| **Nitrous Blue** | `#00AEEF` | Accent — gauges, highlights, active states, "RS" in logo |
...
│   │   ├── can/                          # CanDecoder, ObdPids, WiCanConnection
│   │   ├── data/VehicleState.kt          # Immutable state (80+ fields)
│   │   ├── service/CanDataService.kt     # Foreground service + state merge
│   │   └── ui/MainActivity.kt            # Compose UI (6 tabs)
│   ├── app/src/main/res/
│   │   ├── values/colors.xml             # Nitrous Blue + Frost White palette
│   │   └── mipmap-*/ic_launcher*.png     # App icon (all densities)
│   ├── browser-emulator/index.html       # Standalone browser emulator
│   ├── docs/                             # android-auto-setup, pid-reference, hardware-setup
│   └── app/libs/AAUTO_SDK.md            # Instructions for custom AA UI (Phase 3)
├── docs/
│   └── index.html                        # GitHub Pages — live emulator
└── README.md
```
